! function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("material-components-web", [], e) : "object" == typeof exports ? exports.mdc = e() : t.mdc = e()
}(this, function() {
    return i = {}, r.m = n = [function(t, e, n) {
        ...
        var c, u = n(1),
            ...
            p = n(4),
            h = a(n(19)),
            f = (c = u.MDCComponent, r(y, c), y.attachTo = function(t, e) {
                void 0 === e && (e = {
                    isUnbounded: void 0
                });
                var n = new y(t);
        ...
        var a, c = n(0),
            ...
            h = [],
            f = (a = c.MDCFoundation, r(y, a), Object.defineProperty(y, "cssClasses", {
                get: function() {
                    return u.cssClasses
                },
                enumerable: !1,
                ...
                if (!this.adapter.isSurfaceDisabled()) {
                    ...
                    if (!n.isActivated) {
                        ...
                        i && void 0 !== t && i.type !== t.type || (n.isActivated = !0, n.isProgrammatic = void 0 === t, n.activationEvent = t, n.wasActivatedByPointer = !n.isProgrammatic && void 0 !== t && ("mousedown" === t.type || "touchstart" === t.type || "pointerdown" === t.type), void 0 !== t && 0 < h.length && h.some(function(t) {
                            return e.adapter.containsEventTarget(t)
                        }) ? this.resetActivationState() : (void 0 !== t && (h.push(t.target), this.registerDeactivationHandlers(t)), n.wasElementMadeActive = this.checkElementMadeActive(t), n.wasElementMadeActive && this.animateActivation(), requestAnimationFrame(function() {
                            h = [], n.wasElementMadeActive || void 0 === t || " " !== t.key && 32 !== t.keyCode || (n.wasElementMadeActive = e.checkElementMadeActive(t), n.wasElementMadeActive && e.animateActivation()), n.wasElementMadeActive || (e.activationState = e.defaultActivationState())
                        })))
                    }
                }
                ...
                this.adapter.updateCssVariable(n, c), this.adapter.updateCssVariable(i, u), clearTimeout(this.activationTimer), clearTimeout(this.fgDeactivationRemovalTimer), this.rmBoundedActivationClasses(), this.adapter.removeClass(o), this.adapter.computeBoundingRect(), this.adapter.addClass(s), this.activationTimer = setTimeout(function() {
                ...
                return {
                    startPoint: t = {
                        x: (t = e.wasActivatedByPointer ? l.getNormalizedEventCoords(n, this.adapter.getWindowPageOffset(), this.adapter.computeBoundingRect()) : {
                ...
                this.maxRadius = this.adapter.isUnbounded() ? e : Math.sqrt(Math.pow(t.frame.width, 2) + Math.pow(t.frame.height, 2)) + y.numbers.PADDING;
        ...
        Object.defineProperty(i, "__esModule", {
            value: !0
        }), i.isNavigationEvent = i.normalizeKey = i.KEY = void 0, i.KEY = {
            UNKNOWN: "Unknown",
            BACKSPACE: "Backspace",
            ENTER: "Enter",
            SPACEBAR: "Spacebar",
        ...
        var n = 8,
            ...
            E = 9,
            g = new Map;
        g.set(n, i.KEY.BACKSPACE), g.set(o, i.KEY.ENTER), g.set(s, i.KEY.SPACEBAR), g.set(a, i.KEY.PAGE_UP), g.set(c, i.KEY.PAGE_DOWN), g.set(u, i.KEY.END), g.set(l, i.KEY.HOME), g.set(d, i.KEY.ARROW_LEFT), g.set(p, i.KEY.ARROW_UP), g.set(h, i.KEY.ARROW_RIGHT), g.set(f, i.KEY.ARROW_DOWN), g.set(y, i.KEY.DELETE), g.set(C, i.KEY.ESCAPE), g.set(E, i.KEY.TAB);
        var _ = new Set;
        ...
        _.add(i.KEY.PAGE_UP), _.add(i.KEY.PAGE_DOWN), _.add(i.KEY.END), _.add(i.KEY.HOME), _.add(i.KEY.ARROW_LEFT), _.add(i.KEY.ARROW_UP), _.add(i.KEY.ARROW_RIGHT), _.add(i.KEY.ARROW_DOWN), i.normalizeKey = m, i.isNavigationEvent = function(t) {
            return _.has(m(t))
        }
    }, function(t, e, n) {
        "use strict";
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.evolutionClassNameMap = e.evolutionAttribute = e.deprecatedClassNameMap = e.numbers = e.cssClasses = e.strings = void 0;
        var o = {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.Corner = e.CornerBit = e.numbers = e.strings = e.cssClasses = void 0;
        e.cssClasses = {
        ...
        var o = "mdc-dom-focus-sentinel",
            i = (r.prototype.trapFocus = function() {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.strings = e.InteractionTrigger = void 0, (i = e.InteractionTrigger || (e.InteractionTrigger = {}))[i.UNSPECIFIED = 0] = "UNSPECIFIED", i[i.CLICK = 1] = "CLICK", i[i.BACKSPACE_KEY = 2] = "BACKSPACE_KEY", i[i.DELETE_KEY = 3] = "DELETE_KEY", i[i.SPACEBAR_KEY = 4] = "SPACEBAR_KEY", i[i.ENTER_KEY = 5] = "ENTER_KEY", e.strings = {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.jumpChipKeys = e.navigationKeys = e.cssClasses = e.strings = e.EventSource = e.Direction = void 0, (i = e.Direction || (e.Direction = {})).LEFT = "left", i.RIGHT = "right", (r = e.EventSource || (e.EventSource = {})).PRIMARY = "primary", r.TRAILING = "trailing", r.NONE = "none", e.strings = {
        ...
        var s, a = n(0),
            E = n(8),
            c = (s = a.MDCFoundation, r(g, s), Object.defineProperty(g, "cssClasses", {
                get: function() {
                    return E.cssClasses
                },
                enumerable: !1,
                ...
                this.isSurfaceOpen || (this.adapter.notifyOpening(), this.adapter.saveFocus(), this.isQuickOpen ? (this.isSurfaceOpen = !0, this.adapter.addClass(g.cssClasses.OPEN), this.dimensions = this.adapter.getInnerDimensions(), this.autoposition(), this.adapter.notifyOpen()) : (this.adapter.addClass(g.cssClasses.ANIMATING_OPEN), this.animationRequestId = requestAnimationFrame(function() {
                    t.dimensions = t.adapter.getInnerDimensions(), t.autoposition(), t.adapter.addClass(g.cssClasses.OPEN), t.openAnimationEndTimerId = setTimeout(function() {
                        t.openAnimationEndTimerId = 0, t.adapter.removeClass(g.cssClasses.ANIMATING_OPEN), t.adapter.notifyOpen()
                    }, E.numbers.TRANSITION_OPEN_DURATION)
                }), this.isSurfaceOpen = !0))
            }, g.prototype.close = function(t) {
                var e = this;
                if (void 0 === t && (t = !1), this.isSurfaceOpen) {
                    if (this.adapter.notifyClosing(), this.isQuickOpen) return this.isSurfaceOpen = !1, t || this.maybeRestoreFocus(), this.adapter.removeClass(g.cssClasses.OPEN), this.adapter.removeClass(g.cssClasses.IS_OPEN_BELOW), void this.adapter.notifyClose();
                    this.adapter.addClass(g.cssClasses.ANIMATING_CLOSED), requestAnimationFrame(function() {
                        e.adapter.removeClass(g.cssClasses.OPEN), e.adapter.removeClass(g.cssClasses.IS_OPEN_BELOW), e.closeAnimationEndTimerId = setTimeout(function() {
                            e.closeAnimationEndTimerId = 0, e.adapter.removeClass(g.cssClasses.ANIMATING_CLOSED), e.adapter.notifyClose()
                ...
                var t, e, n = this.originCorner,
                    i = this.measurements,
                    r = i.viewportDistance,
                    o = i.anchorSize,
                    s = i.surfaceSize,
                    a = g.numbers.MARGIN_TO_EDGE;
                !(0 < (e = this.hasBit(this.anchorCorner, E.CornerBit.BOTTOM) ? (t = r.top - a + this.anchorMargin.bottom, r.bottom - a - this.anchorMargin.bottom) : (t = r.top - a + this.anchorMargin.top, r.bottom - a + o.height - this.anchorMargin.top)) - s.height) && t > e + this.openBottomBias && (n = this.setBit(n, E.CornerBit.BOTTOM));
                var c, u, l = this.adapter.isRtl(),
                    d = this.hasBit(this.anchorCorner, E.CornerBit.FLIP_RTL),
                    p = this.hasBit(this.anchorCorner, E.CornerBit.RIGHT) || this.hasBit(n, E.CornerBit.RIGHT),
                    h = !1;
                ...
                var f = 0 < c - s.width,
                    y = 0 < u - s.width,
                    C = this.hasBit(n, E.CornerBit.FLIP_RTL) && this.hasBit(n, E.CornerBit.RIGHT);
                return y && C && l || !f && C ? n = this.unsetBit(n, E.CornerBit.RIGHT) : (f && h && l || f && !h && p || !y && u <= c) && (n = this.setBit(n, E.CornerBit.RIGHT)), n
                ...
                var t = this,
                    ...
                    n = this.adapter.getOwnerDocument ? this.adapter.getOwnerDocument() : document,
                    i = n.activeElement && this.adapter.isElementInContainer(n.activeElement);
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.DefaultFocusState = e.numbers = e.strings = e.cssClasses = void 0;
        e.cssClasses = {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.Action = e.CloseReason = e.selectors = e.events = e.numbers = e.cssClasses = void 0, e.cssClasses = {
        ...
        }, (i = e.CloseReason || (e.CloseReason = {}))[i.PRIMARY = 0] = "PRIMARY", i[i.SECONDARY = 1] = "SECONDARY", i[i.UNSPECIFIED = 2] = "UNSPECIFIED", (r = e.Action || (e.Action = {}))[r.PRIMARY = 0] = "PRIMARY", r[r.SECONDARY = 1] = "SECONDARY", r[r.UNKNOWN = 2] = "UNKNOWN"
    }, function(t, e, n) {
        "use strict";
        var s;
        Object.defineProperty(e, "__esModule", {
        ...
        var d, p = (d = c.MDCFoundation, r(h, d), Object.defineProperty(h, "strings", {
            ...
            var e = this,
                n = this.adapter.eventTargetHasClass(t.target, u.cssClasses.CHIP_EXIT),
            ...
            this.eventFromPrimaryAction(t) && this.adapter.addClass(u.cssClasses.PRIMARY_ACTION_FOCUSED)
        }, h.prototype.handleFocusOut = function(t) {
            this.eventFromPrimaryAction(t) && (this.isEditing() && this.finishEditing(), this.adapter.removeClass(u.cssClasses.PRIMARY_ACTION_FOCUSED))
            ...
            if (!this.isEditing()) return this.isEditable() && this.shouldStartEditing(t) && (t.preventDefault(), this.startEditing()), this.shouldNotifyInteraction(t) ? (this.adapter.notifyInteraction(), void this.setPrimaryActionFocusable(this.getFocusBehavior())) : this.isDeleteAction(t) ? (t.preventDefault(), void this.removeChip()) : void(u.navigationKeys.has(t.key) && (t.preventDefault(), this.focusNextAction(t.key, u.EventSource.PRIMARY)));
            ...
            !u.jumpChipKeys.has(t) && n ? e !== u.EventSource.PRIMARY || i !== u.Direction.RIGHT ? e !== u.EventSource.TRAILING || i !== u.Direction.LEFT ? this.adapter.notifyNavigation(t, u.EventSource.NONE) : this.focusPrimaryAction() : this.focusTrailingAction() : this.adapter.notifyNavigation(t, e)
        }, h.prototype.getDirection = function(t) {
            var e = this.adapter.isRTL(),
                n = t === u.strings.ARROW_LEFT_KEY || t === u.strings.IE_ARROW_LEFT_KEY,
            ...
            return this.eventFromPrimaryAction(t) && t.key === u.strings.ENTER_KEY
        ...
        function h(t) {
            ...
            return e.shouldRemoveOnTrailingIconClick = !0, e.shouldFocusPrimaryActionOnClick = !0, e
        }
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.events = e.SortValue = e.strings = e.messages = e.selectors = e.dataAttributes = e.attributes = e.cssClasses = void 0, e.cssClasses = {
                ...
                var r = this,
                    t = {
                        ...
                        notifySelectionChange: function(t) {
                            r.emit(c.strings.SELECTION_CHANGE_EVENT, {
                                changedIndices: t
                            }, !0)
                        },
        ...
        var i, r = this && this.__extends || (i = function(t, e) {
            ...
            c = this && this.__importStar || function(t) {
                ...
                var e = {};
                if (null != t)
                    for (var n in t) "default" !== n && Object.prototype.hasOwnProperty.call(t, n) && s(e, t, n);
                return a(e, t), e
            },
            ...
            p = this && this.__spreadArray || function(t, e) {
                for (var n = 0, i = e.length, r = t.length; n < i; n++, r++) t[r] = e[n];
                return t
            };
        Object.defineProperty(e, "__esModule", {
        ...
        function O(e) {
            var n = new Set(e ? l.filter(function(t) {
        ...
        var h, f = (h = u.MDCFoundation, r(y, h), Object.defineProperty(y, "strings", {
            get: function() {
                return T.strings
            },
            enumerable: !1,
            ...
            (this.isSingleSelectionList = t) && (this.maybeInitializeSingleSelection(), this.selectedIndex = this.getSelectedIndexFromDOM())
            ...
            t !== T.numbers.UNSET_INDEX && (this.adapter.listItemAtIndexHasClass(t, T.cssClasses.LIST_ITEM_ACTIVATED_CLASS) && this.setUseActivatedClass(!0), this.isSingleSelectionList = !0, this.selectedIndex = t)
        }, y.prototype.getSelectedIndexFromDOM = function() {
            for (var t = T.numbers.UNSET_INDEX, e = this.adapter.getListItemCount(), n = 0; n < e; n++) {
                var i = this.adapter.listItemAtIndexHasClass(n, T.cssClasses.LIST_ITEM_SELECTED_CLASS),
                    r = this.adapter.listItemAtIndexHasClass(n, T.cssClasses.LIST_ITEM_ACTIVATED_CLASS);
                if (i || r) {
                    t = n;
                    break
                }
            ...
            0 <= t && (this.focusedItemIndex = t, this.adapter.setAttributeForElementIndex(t, "tabindex", "0"), this.adapter.setTabIndexForListItemChildren(t, "0"))
        }, y.prototype.handleFocusOut = function(t) {
            var e = this;
            0 <= t && (this.adapter.setAttributeForElementIndex(t, "tabindex", "-1"), this.adapter.setTabIndexForListItemChildren(t, "-1")), setTimeout(function() {
                e.adapter.isFocusInsideList() || e.setTabindexToFirstSelectedOrFocusedItem()
            }, 0)
        }, y.prototype.isIndexDisabled = function(t) {
            return this.adapter.listItemAtIndexHasClass(t, T.cssClasses.LIST_ITEM_DISABLED_CLASS)
            ...
            if (this.adapter.isRootFocused()) {
                ...
                if (!(-1 === g && (g = n) < 0)) {
                    if (h && C([])) b.preventDefaultEvent(t), this.focusNextElement(g);
                    else if (f && C([])) b.preventDefaultEvent(t), this.focusPrevElement(g);
                    else if (h && C(["Shift"]) && this.isCheckboxList) b.preventDefaultEvent(t), -1 !== (_ = this.focusNextElement(g)) && this.setSelectedIndexOnAction(_, !1);
                    else if (f && C(["Shift"]) && this.isCheckboxList) {
                        var _;
                        b.preventDefaultEvent(t), -1 !== (_ = this.focusPrevElement(g)) && this.setSelectedIndexOnAction(_, !1)
                    } else if (u && C([])) b.preventDefaultEvent(t), this.focusFirstElement();
                    else if (l && C([])) b.preventDefaultEvent(t), this.focusLastElement();
                    else if (u && C(["Control", "Shift"]) && this.isCheckboxList) {
                        if (b.preventDefaultEvent(t), this.isIndexDisabled(g)) return;
                        this.focusFirstElement(), this.toggleCheckboxRange(0, g, g)
                    } else if (l && C(["Control", "Shift"]) && this.isCheckboxList) {
                        if (b.preventDefaultEvent(t), this.isIndexDisabled(g)) return;
                        this.focusLastElement(), this.toggleCheckboxRange(g, this.adapter.getListItemCount() - 1, g)
                    } else if (y && C(["Control"]) && this.isCheckboxList) t.preventDefault(), this.checkboxListToggleAll(this.selectedIndex === T.numbers.UNSET_INDEX ? [] : this.selectedIndex, !0);
                    else if ((d || p) && C([])) {
                        if (e) {
                            if ((m = t.target) && "A" === m.tagName && d) return;
                            if (b.preventDefaultEvent(t), this.isIndexDisabled(g)) return;
                            this.isTypeaheadInProgress() || (this.isSelectableList() && this.setSelectedIndexOnAction(g, !1), this.adapter.notifyAction(g))
                        }
                    } else if ((d || p) && C(["Shift"]) && this.isCheckboxList) {
                        var m;
                        if ((m = t.target) && "A" === m.tagName && d) return;
                        if (b.preventDefaultEvent(t), this.isIndexDisabled(g)) return;
                        this.isTypeaheadInProgress() || (this.toggleCheckboxRange(null !== (i = this.lastSelectedIndex) && void 0 !== i ? i : g, g, g), this.adapter.notifyAction(g))
                    }
                    this.hasTypeahead && (E = {
                        event: t,
                        focusItemAtIndex: function(t) {
            ...
            var i, r = O(n);
            t !== T.numbers.UNSET_INDEX && (this.isIndexDisabled(t) || (r([]) ? (this.isSelectableList() && this.setSelectedIndexOnAction(t, e), this.adapter.notifyAction(t)) : this.isCheckboxList && r(["Shift"]) && (this.toggleCheckboxRange(null !== (i = this.lastSelectedIndex) && void 0 !== i ? i : t, t, t), this.adapter.notifyAction(t))))
            ...
            this.adapter.setCheckedCheckboxOrRadioAtIndex(t, !0), this.selectedIndex === t && !e.forceUpdate || (this.selectedIndex !== T.numbers.UNSET_INDEX && this.adapter.setAttributeForElementIndex(this.selectedIndex, n, "false"), this.adapter.setAttributeForElementIndex(t, n, "true"), this.selectedIndex = t, e.isUserInteraction && !e.forceUpdate && this.adapter.notifySelectionChange([t]))
        }, y.prototype.setCheckboxAtIndex = function(t, e) {
            void 0 === e && (e = {});
            for (var n = this.selectedIndex, i = e.isUserInteraction ? new Set(n === T.numbers.UNSET_INDEX ? [] : n) : null, r = this.getSelectionAttribute(), o = [], s = 0; s < this.adapter.getListItemCount(); s++) {
                var a = null == i ? void 0 : i.has(s),
                    c = 0 <= t.indexOf(s);
                c !== a && o.push(s), this.adapter.setCheckedCheckboxOrRadioAtIndex(s, c), this.adapter.setAttributeForElementIndex(s, r, c ? "true" : "false")
            }
            ...
            for (var i = new Set(this.selectedIndex === T.numbers.UNSET_INDEX ? [] : this.selectedIndex), r = !(null == i ? void 0 : i.has(n)), o = d([t, e].sort(), 2), s = o[0], a = o[1], c = this.getSelectionAttribute(), u = [], l = s; l <= a; l++) this.isIndexDisabled(l) || r !== i.has(l) && (u.push(l), this.adapter.setCheckedCheckboxOrRadioAtIndex(l, r), this.adapter.setAttributeForElementIndex(l, c, "" + r), r ? i.add(l) : i.delete(l));
            u.length && (this.selectedIndex = p([], d(i)), this.adapter.notifySelectionChange(u))
            ...
            return this.isSelectableList() ? "number" == typeof this.selectedIndex && this.selectedIndex !== T.numbers.UNSET_INDEX ? this.selectedIndex : function(t) {
                return t instanceof Array
            }(this.selectedIndex) && 0 < this.selectedIndex.length ? this.selectedIndex.reduce(function(t, e) {
                return Math.min(t, e)
            ...
            return this.isIndexInRange(t) || this.isSingleSelectionList && t === T.numbers.UNSET_INDEX
            ...
            var n, i = this.getSelectionAttribute(),
                r = this.adapter.isCheckboxCheckedAtIndex(e);
            t ? n = r : (n = !r, this.adapter.setCheckedCheckboxOrRadioAtIndex(e, n)), this.adapter.setAttributeForElementIndex(e, i, n ? "true" : "false");
            var o = this.selectedIndex === T.numbers.UNSET_INDEX ? [] : this.selectedIndex.slice();
            n ? o.push(e) : o = o.filter(function(t) {
                return t !== e
            ...
            if (t.length === n) this.setCheckboxAtIndex([], {
                isUserInteraction: e
            });
            else {
                for (var i = [], r = 0; r < n; r++)(!this.isIndexDisabled(r) || -1 < t.indexOf(r)) && i.push(r);
        ...
        var s, a = n(0),
            ...
            u = (s = a.MDCFoundation, r(l, s), Object.defineProperty(l, "strings", {
                ...
                var e = c.cssClasses.OPENING,
                    ...
                    o = c.cssClasses.ROOT;
                this.isElement(t.target) && this.adapter.elementHasClass(t.target, o) && (this.isClosing() ? (this.adapter.removeClass(i), this.closed(), this.adapter.restoreFocus(), this.adapter.notifyClose()) : (this.adapter.focusActiveNavigationItem(), this.opened(), this.adapter.notifyOpen()), this.adapter.removeClass(r), this.adapter.removeClass(e), this.adapter.removeClass(n))
            }, l.prototype.opened = function() {}, l.prototype.closed = function() {}, l.prototype.runNextAnimationFrame = function(t) {
                var e = this;
        ...
        var o, s = n(1),
            a = n(3),
            c = n(28),
            u = (o = s.MDCComponent, r(l, o), l.attachTo = function(t) {
                return new l(t)
        ...
        function l(t) {
            var e = s.call(this, o(o({}, l.defaultAdapter), t)) || this;
            return e.shakeAnimationEndHandler = function() {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.strings = e.events = e.attributes = e.numbers = e.cssClasses = void 0, e.cssClasses = {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.Thumb = e.TickMark = void 0, (i = e.TickMark || (e.TickMark = {}))[i.ACTIVE = 0] = "ACTIVE", i[i.INACTIVE = 1] = "INACTIVE", (r = e.Thumb || (e.Thumb = {}))[r.START = 1] = "START", r[r.END = 2] = "END"
    }, function(t, e, n) {
        "use strict";
        var i;
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.Selectors = e.CssClasses = void 0, (i = e.CssClasses || (e.CssClasses = {})).PROCESSING = "mdc-switch--processing", i.SELECTED = "mdc-switch--selected", i.UNSELECTED = "mdc-switch--unselected", (e.Selectors || (e.Selectors = {})).RIPPLE = ".mdc-switch__ripple"
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var s, a = n(0),
            ...
            u = (s = a.MDCFoundation, r(l, s), Object.defineProperty(l, "cssClasses", {
                ...
                this.adapter.addClass(c.cssClasses.ACTIVE), this.adapter.setAttr(c.strings.ARIA_SELECTED, "true"), this.adapter.setAttr(c.strings.TABINDEX, "0"), this.adapter.activateIndicator(t), this.focusOnActivate && this.adapter.focus()
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.ALWAYS_FLOAT_TYPES = e.VALIDATION_ATTR_WHITELIST = e.numbers = e.strings = e.cssClasses = void 0;
        e.strings = {
            ARIA_CONTROLS: "aria-controls",
            ARIA_DESCRIBEDBY: "aria-describedby",
        ...
        var s, a = n(0),
            ...
            u = (s = a.MDCFoundation, r(l, s), Object.defineProperty(l, "cssClasses", {
                ...
                n ? (this.showToScreenReader(), "alert" === this.adapter.getAttr(c.strings.ROLE) ? this.refreshAlertRole() : this.adapter.setAttr(c.strings.ROLE, "alert")) : this.adapter.removeAttr(c.strings.ROLE), e || n || this.hide()
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.XPositionWithCaret = e.YPositionWithCaret = e.PositionWithCaret = e.strings = e.YPosition = e.AnchorBoundaryType = e.XPosition = e.events = e.attributes = e.numbers = e.CssClasses = void 0, (r = i = i || {}).RICH = "mdc-tooltip--rich", r.SHOWN = "mdc-tooltip--shown", r.SHOWING = "mdc-tooltip--showing", r.SHOWING_TRANSITION = "mdc-tooltip--showing-transition", r.HIDE = "mdc-tooltip--hide", r.HIDE_TRANSITION = "mdc-tooltip--hide-transition", r.MULTILINE_TOOLTIP = "mdc-tooltip--multiline", r.SURFACE = "mdc-tooltip__surface", r.SURFACE_ANIMATION = "mdc-tooltip__surface-animation", r.TOOLTIP_CARET_TOP = "mdc-tooltip__caret-surface-top", r.TOOLTIP_CARET_BOTTOM = "mdc-tooltip__caret-surface-bottom", e.CssClasses = i;
        e.numbers = {
        ...
        }, (s = o = o || {})[s.DETECTED = 0] = "DETECTED", s[s.START = 1] = "START", s[s.CENTER = 2] = "CENTER", s[s.END = 3] = "END", e.XPosition = o, (c = a = a || {})[c.DETECTED = 0] = "DETECTED", c[c.ABOVE = 1] = "ABOVE", c[c.BELOW = 2] = "BELOW", e.YPosition = a, (l = u = u || {})[l.BOUNDED = 0] = "BOUNDED", l[l.UNBOUNDED = 1] = "UNBOUNDED", e.AnchorBoundaryType = u;
        var d, p, h, f, y, C;
        e.strings = {
            LEFT: "left",
            RIGHT: "right",
        ...
        var o, s = n(9),
            ...
            c = (o = a.MDCTopAppBarBaseFoundation, r(u, o), u.prototype.destroy = function() {
                ...
                this.lastScrollPosition = t, this.isCurrentlyBeingResized || (this.currentAppBarOffsetTop -= e, 0 < this.currentAppBarOffsetTop ? this.currentAppBarOffsetTop = 0 : Math.abs(this.currentAppBarOffsetTop) > this.topAppBarHeight && (this.currentAppBarOffsetTop = -this.topAppBarHeight), this.moveTopAppBar())
                ...
                }, s.numbers.DEBOUNCE_THROTTLE_RESIZE_TIME_MS)), this.isCurrentlyBeingResized = !0, this.resizeDebounceId && clearTimeout(this.resizeDebounceId), this.resizeDebounceId = setTimeout(function() {
                    t.handleTargetScroll(), t.isCurrentlyBeingResized = !1, t.resizeDebounceId = 0
                ...
                if (i) this.wasDocked = !1;
                    ...
                    if (this.isDockedShowing !== n) return this.isDockedShowing = n, !0
                }
                return i
            }, u.prototype.moveTopAppBar = function() {
                if (this.checkForUpdate()) {
                    var t = this.currentAppBarOffsetTop;
                    Math.abs(t) >= this.topAppBarHeight && (t = -s.numbers.MAX_TOP_APP_BAR_HEIGHT), this.adapter.setStyle("top", t + "px")
                }
        ...
        function u(t) {
            ...
            return e.wasDocked = !0, e.isDockedShowing = !0, e.currentAppBarOffsetTop = 0, e.isCurrentlyBeingResized = !1, e.resizeThrottleId = 0, e.resizeDebounceId = 0, e.lastScrollPosition = e.adapter.getViewportScrollY(), e.topAppBarHeight = e.adapter.getTopAppBarHeight(), e
        }
        ...
        var s, a = n(0),
            ...
            p = (s = a.MDCFoundation, r(h, s), Object.defineProperty(h, "defaultAdapter", {
                ...
                void 0 === t && (t = !1), t ? this.adapter.notifyActionClicked(0) : this.close(c.CloseReason.PRIMARY)
            }, h.prototype.handleSecondaryActionClick = function(t) {
                void 0 === t && (t = !1), t ? this.adapter.notifyActionClicked(1) : this.close(c.CloseReason.SECONDARY)
        ...
        var s, a = n(10),
            ...
            g = (s = c.MDCComponent, r(_, s), _.attachTo = function(t) {
                return new _(t)
                ...
                this.getNativeControl().indeterminate = "true" === this.getNativeControl().getAttribute(t), this.getNativeControl().removeAttribute(t)
                ...
                var n = this,
                    t = o(o({}, h.MDCRipple.createAdapter(this)), {
                        deregisterInteractionHandler: function(t, e) {
                            n.getNativeControl().removeEventListener(t, e, d.applyPassive())
                        },
                        isSurfaceActive: function() {
                        ...
                        registerInteractionHandler: function(t, e) {
                            n.getNativeControl().addEventListener(t, e, d.applyPassive())
                        }
                    });
                ...
                try {
                    for (var i = l(E), a = i.next(); !a.done; a = i.next()) {
                        var c = t(a.value);
                        if ("object" === (void 0 === c ? "undefined" : u(c))) return c.value
                    }
                } catch (t) {
                    e = {
                        error: t
                ...
                var e, t, n = this.getNativeControl(),
        ...
        var s, a = n(0),
            p = n(20),
            c = (s = a.MDCFoundation, r(h, s), Object.defineProperty(h, "cssClasses", {
                get: function() {
                    return p.cssClasses
                },
                enumerable: !1,
                ...
                this.currentCheckState = this.determineCheckState(), this.updateAriaChecked(), this.adapter.addClass(p.cssClasses.UPGRADED)
            }, h.prototype.destroy = function() {
                ...
                if (this.adapter.hasNativeControl()) {
                    ...
                    if (t !== e) {
                        ...
                        e === n ? this.adapter.removeClass(i) : this.adapter.addClass(i), 0 < this.currentAnimationClass.length && (clearTimeout(this.animEndLatchTimer), this.adapter.forceLayout(), this.adapter.removeClass(this.currentAnimationClass)), this.currentAnimationClass = this.getTransitionAnimationClass(t, e), this.currentCheckState = e, this.adapter.isAttachedToDOM() && 0 < this.currentAnimationClass.length && (this.adapter.addClass(this.currentAnimationClass), this.enableAnimationEndHandler = !0)
                    }
                }
        ...
        function h(t) {
            var e = s.call(this, o(o({}, h.defaultAdapter), t)) || this;
            return e.currentCheckState = p.strings.TRANSITION_STATE_INIT, e.currentAnimationClass = "", e.animEndLatchTimer = 0, e.enableAnimationEndHandler = !1, e
        }
                ...
                var n = this,
                    t = {
                        ...
                        notifyInteraction: function(t) {
                            return n.emit(u.strings.INTERACTION_EVENT, {
                                trigger: t
                            }, !0)
                        },
                        notifyNavigation: function(t) {
                            n.emit(u.strings.NAVIGATION_EVENT, {
                                key: t
                            }, !0)
                        },
        ...
        var s, a = n(1),
            ...
            p = n(13),
            h = n(21),
            f = (s = a.MDCComponent, r(y, s), Object.defineProperty(y.prototype, "selected", {
                get: function() {
                ...
                enumerable: !1,
                configurable: !0
            }), Object.defineProperty(y.prototype, "shouldRemoveOnTrailingIconClick", {
                get: function() {
                ...
                enumerable: !1,
                configurable: !0
            }), Object.defineProperty(y.prototype, "setShouldFocusPrimaryActionOnClick", {
                set: function(t) {
                ...
                }), this.leadingIcon = this.root.querySelector(p.strings.LEADING_ICON_SELECTOR), this.checkmark = this.root.querySelector(p.strings.CHECKMARK_SELECTOR), this.primaryAction = this.root.querySelector(p.strings.PRIMARY_ACTION_SELECTOR);
                ...
                var n = this,
                    t = {
                        ...
                        isTrailingActionNavigable: function() {
                            return !!n.trailingAction && n.trailingAction.isNavigable()
                        },
                        notifyInteraction: function() {
                            return n.emit(p.strings.INTERACTION_EVENT, {
                                chipId: n.id
                            }, !0)
                        },
                        notifyNavigation: function(t, e) {
                            return n.emit(p.strings.NAVIGATION_EVENT, {
                                chipId: n.id,
                                key: t,
                                source: e
                            }, !0)
                        ...
                        notifyRemoval: function(t) {
                            n.emit(p.strings.REMOVAL_EVENT, {
                                chipId: n.id,
                                removedAnnouncement: t
                            }, !0)
                        },
                        notifySelection: function(t, e) {
                            return n.emit(p.strings.SELECTION_EVENT, {
                                chipId: n.id,
                                selected: t,
                                shouldIgnore: e
                            }, !0)
                        ...
                        notifyTrailingIconInteraction: function() {
                            return n.emit(p.strings.TRAILING_ICON_INTERACTION_EVENT, {
                                chipId: n.id
                            }, !0)
                        },
                        notifyEditStart: function() {},
        ...
        var s, a = n(0),
            ...
            u = (s = a.MDCFoundation, r(l, s), Object.defineProperty(l, "strings", {
                ...
                this.removeFocusFromChipsExcept(n), (this.adapter.hasClass(c.cssClasses.CHOICE) || this.adapter.hasClass(c.cssClasses.FILTER)) && this.toggleSelect(e)
                ...
                if (!(r < 0)) {
                    var o = Math.min(i, r);
                    this.removeFocusFromChipsExcept(o), this.adapter.focusChipTrailingActionAtIndex(o)
                }
                ...
                if (-1 !== o && h.navigationKeys.has(n)) {
                    var s = this.adapter.isRTL(),
                        a = n === h.strings.ARROW_LEFT_KEY || n === h.strings.IE_ARROW_LEFT_KEY,
                        c = n === h.strings.ARROW_RIGHT_KEY || n === h.strings.IE_ARROW_RIGHT_KEY,
                        u = n === h.strings.ARROW_DOWN_KEY || n === h.strings.IE_ARROW_DOWN_KEY,
                        l = !s && c || s && a || u,
                        d = n === h.strings.HOME_KEY,
                        p = n === h.strings.END_KEY;
                    l ? o++ : d ? o = 0 : p ? o = r : o--, o < 0 || r < o || (this.removeFocusFromChipsExcept(o), this.focusChipAction(o, n, i))
                }
                ...
                var e = this.adapter.isRTL(),
                    n = t === h.strings.ARROW_LEFT_KEY || t === h.strings.IE_ARROW_LEFT_KEY,
                ...
                0 <= this.selectedChipIds.indexOf(t) ? this.deselectAndNotifyClients(t) : this.selectAndNotifyClients(t)
                ...
                if (!(0 <= this.selectedChipIds.indexOf(t))) {
                    if (this.adapter.hasClass(c.cssClasses.CHOICE) && 0 < this.selectedChipIds.length) {
                        ...
                        this.selectedChipIds = [], this.adapter.selectChipAtIndex(i, !1, e)
                    }
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.cssClasses = e.strings = void 0, e.strings = {
        ...
        var c, u = n(0),
            ...
            d = (c = u.MDCFoundation, r(p, c), Object.defineProperty(p, "defaultAdapter", {
                ...
                var o = this.adapter.getAttributeByHeaderCellIndex(n, l.strings.ARIA_SORT),
                    s = l.SortValue.NONE;
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.areTopsMisaligned = e.isScrollAtBottom = e.isScrollAtTop = e.isScrollable = e.createFocusTrapInstance = void 0, e.createFocusTrapInstance = function(t, e, n) {
            return e(t, {
                initialFocusEl: n
            })
        ...
        var d, p = (d = u.MDCFoundation, r(h, d), Object.defineProperty(h, "cssClasses", {
            ...
            if (this.adapter.eventTargetMatches(t.target, l.strings.SCRIM_SELECTOR) && "" !== this.scrimClickAction) this.close(this.scrimClickAction);
            else {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.createFocusTrapInstance = void 0, e.createFocusTrapInstance = function(t, e) {
            return e(t, {
                skipInitialFocus: !0
            })
        }
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.cssClasses = void 0, e.cssClasses = {
        ...
        function l(t) {
            var e = s.call(this, o(o({}, l.defaultAdapter), t)) || this;
            return e.transitionEndHandler = function(t) {
        ...
        var o, s = n(1),
            ...
            l = (o = s.MDCComponent, r(d, o), d.attachTo = function(t) {
                ...
                this.anchorElement = t && t.classList.contains(a.cssClasses.ANCHOR) ? t : null, this.root.classList.contains(a.cssClasses.FIXED) && this.setFixedPosition(!0), this.handleKeydown = function(t) {
                    ...
                    document.body.removeEventListener("click", e.handleBodyClick, {
                        capture: !0
                    })
                ...
                var n = this,
                    t = {
                        ...
                        notifyOpening: function() {
                            return n.emit(c.MDCMenuSurfaceFoundation.strings.OPENING_EVENT, {})
                        },
        ...
        var o, s = n(1),
            ...
            h = n(15),
            f = n(76),
            y = (o = s.MDCComponent, r(C, o), C.attachTo = function(t) {
                return new C(t)
                ...
                t ? (this.list = this.listFactory(t), this.list.wrapFocus = !0) : this.list = null, this.handleKeydown = function(t) {
                    e.foundation.handleKeydown(t)
                ...
                this.list && this.list.destroy(), this.menuSurface.destroy(), this.menuSurface.unlisten(p.MDCMenuSurfaceFoundation.strings.OPENED_EVENT, this.handleMenuSurfaceOpened), this.unlisten("keydown", this.handleKeydown), this.unlisten(l.MDCListFoundation.strings.ACTION_EVENT, this.handleItemAction), o.prototype.destroy.call(this)
        ...
        var s, a = n(0),
            ...
            d = (s = a.MDCFoundation, r(p, s), Object.defineProperty(p, "cssClasses", {
                ...
                if (!(t < 0)) {
                    ...
                    var i = "true" === this.adapter.getAttributeFromElementAtIndex(t, l.strings.SKIP_RESTORE_FOCUS);
                    this.adapter.closeSurface(i), this.closeAnimationEndTimerId = setTimeout(function() {
                ...
                0 <= e && (this.adapter.removeAttributeFromElementAtIndex(e, l.strings.ARIA_CHECKED_ATTR), this.adapter.removeClassFromElementAtIndex(e, l.cssClasses.MENU_SELECTED_LIST_ITEM)), this.adapter.addClassToElementAtIndex(t, l.cssClasses.MENU_SELECTED_LIST_ITEM), this.adapter.addAttributeToElementAtIndex(t, l.strings.ARIA_CHECKED_ATTR, "true"), this.selectedIndex = t
            }, p.prototype.setEnabled = function(t, e) {
                this.validatedIndex(t), e ? (this.adapter.removeClassFromElementAtIndex(t, c.cssClasses.LIST_ITEM_DISABLED_CLASS), this.adapter.addAttributeToElementAtIndex(t, l.strings.ARIA_DISABLED_ATTR, "false")) : (this.adapter.addClassToElementAtIndex(t, c.cssClasses.LIST_ITEM_DISABLED_CLASS), this.adapter.addAttributeToElementAtIndex(t, l.strings.ARIA_DISABLED_ATTR, "true"))
        ...
        function p(t) {
            var e = s.call(this, o(o({}, p.defaultAdapter), t)) || this;
            return e.closeAnimationEndTimerId = 0, e.defaultFocusState = l.DefaultFocusState.LIST_ROOT, e.selectedIndex = -1, e
        }
        ...
        var a, c = n(0),
            u = n(81),
            l = (a = c.MDCFoundation, r(d, a), Object.defineProperty(d, "defaultAdapter", {
                get: function() {
                    return {
                        hasClass: function() {
                            return !1
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.cssClasses = e.events = e.selectors = void 0, e.selectors = {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.cssClasses = e.events = e.attributes = e.booleans = void 0, e.booleans = {
            TRUE: "true",
            FALSE: "false"
        }, e.attributes = {
            ARIA_CHECKED: "aria-checked",
            ...
            d = (s = a.MDCFoundation, r(p, s), Object.defineProperty(p, "cssClasses", {
                ...
                if (!this.isMenuOpen && this.adapter.hasClass(l.cssClasses.FOCUSED)) {
                    ...
                    if (!t.ctrlKey && !t.metaKey && (!n && t.key && 1 === t.key.length || n && this.adapter.isTypeaheadInProgress())) {
                        var o = n ? " " : t.key,
                            s = this.adapter.typeaheadMatchItem(o, this.getSelectedIndex());
        ...
        var a, c = n(0),
            u = n(91),
            l = ["click", "keydown"],
            d = (a = c.MDCFoundation, r(p, a), Object.defineProperty(p, "strings", {
                get: function() {
                    return u.strings
                },
                enumerable: !1,
                ...
                this.savedTabIndex && (t ? (this.adapter.setAttr("tabindex", "-1"), this.adapter.removeAttr("role")) : (this.adapter.setAttr("tabindex", this.savedTabIndex), this.adapter.setAttr("role", u.strings.ICON_ROLE)))
        ...
        function p(t) {
            ...
            return e.savedTabIndex = null, e.interactionHandler = function(t) {
        ...
        var c, h = "undefined" != typeof window,
            f = (c = a.MDCFoundation, r(y, c), Object.defineProperty(y, "defaultAdapter", {
                get: function() {
                    return {
                        hasClass: function() {
                            return !1
                ...
                var e = this.convertAttributeValueToNumber(this.adapter.getInputAttribute(u.attributes.INPUT_MIN, this.isRange ? p.Thumb.START : p.Thumb.END), u.attributes.INPUT_MIN),
                    n = this.convertAttributeValueToNumber(this.adapter.getInputAttribute(u.attributes.INPUT_MAX, p.Thumb.END), u.attributes.INPUT_MAX),
                    i = this.convertAttributeValueToNumber(this.adapter.getInputAttribute(u.attributes.INPUT_VALUE, p.Thumb.END), u.attributes.INPUT_VALUE),
                    r = this.isRange ? this.convertAttributeValueToNumber(this.adapter.getInputAttribute(u.attributes.INPUT_VALUE, p.Thumb.START), u.attributes.INPUT_VALUE) : e,
                    o = this.adapter.getInputAttribute(u.attributes.INPUT_STEP, p.Thumb.END),
                    s = o ? this.convertAttributeValueToNumber(o, u.attributes.INPUT_STEP) : this.step,
                    a = this.adapter.getAttribute(u.attributes.DATA_MIN_RANGE),
                    c = a ? this.convertAttributeValueToNumber(a, u.attributes.DATA_MIN_RANGE) : this.minRange;
                this.validateProperties({
                    ...
                    step: s,
                    minRange: c
                }), this.min = e, this.max = n, this.value = i, this.valueStart = r, this.step = s, this.minRange = c, this.numDecimalPlaces = C(this.step), this.valueBeforeDownEvent = i, this.valueStartBeforeDownEvent = r, this.mousedownOrTouchstartListener = this.handleMousedownOrTouchstart.bind(this), this.moveListener = this.handleMove.bind(this), this.pointerdownListener = this.handlePointerdown.bind(this), this.pointerupListener = this.handlePointerup.bind(this), this.thumbMouseenterListener = this.handleThumbMouseenter.bind(this), this.thumbMouseleaveListener = this.handleThumbMouseleave.bind(this), this.inputStartChangeListener = function() {
                ...
                if (this.isRange && t < this.valueStart + this.minRange) throw new Error("end thumb value (" + t + ") must be >= start thumb value (" + this.valueStart + ") + min range (" + this.minRange + ")");
                ...
                if (!this.isRange) throw new Error("`valueStart` is only applicable for range sliders.");
                if (this.isRange && t > this.value - this.minRange) throw new Error("start thumb value (" + t + ") must be <= end thumb value (" + this.value + ") - min range (" + this.minRange + ")");
                this.updateValue(t, p.Thumb.START)
            }, y.prototype.setStep = function(t) {
                this.step = t, this.numDecimalPlaces = C(t), this.updateUI()
            }, y.prototype.setMinRange = function(t) {
                if (!this.isRange) throw new Error("`minRange` is only applicable for range sliders.");
                if (t < 0) throw new Error("`minRange` must be non-negative. Current value: " + t);
                if (this.value - this.valueStart < t) throw new Error("start thumb value (" + this.valueStart + ") and end thumb value (" + this.value + ") must differ by at least " + t + ".");
                this.minRange = t
                ...
                if (!this.isDisabled) {
                    ...
                    this.thumb = this.getThumbFromDownEvent(e, n), null !== this.thumb && (this.handleDragStart(t, n, this.thumb), this.updateValue(n, this.thumb, {
                        emitInputEvent: !0
                    }))
                }
                ...
                if (!this.isDisabled) {
                    ...
                    if (this.thumb = this.getThumbFromMoveEvent(e), null !== this.thumb) {
                        ...
                        n || (this.handleDragStart(t, i, this.thumb), this.adapter.emitDragStartEvent(i, this.thumb)), this.updateValue(i, this.thumb, {
                            emitInputEvent: !0
                        })
                    }
                }
                ...
                if (!this.isDisabled && null !== this.thumb) {
                    (null === (e = (t = this.adapter).shouldHideFocusStylesForPointerEvents) || void 0 === e ? void 0 : e.call(t)) && this.handleInputBlur(this.thumb);
                    var n = this.thumb === p.Thumb.START ? this.valueStartBeforeDownEvent : this.valueBeforeDownEvent,
                        i = this.thumb === p.Thumb.START ? this.valueStart : this.value;
                    n !== i && this.adapter.emitChangeEvent(i, this.thumb), this.adapter.emitDragEndEvent(i, this.thumb), this.thumb = null
                }
            }, y.prototype.handleThumbMouseenter = function() {
                this.isDiscrete && this.isRange && (this.adapter.addThumbClass(u.cssClasses.THUMB_WITH_INDICATOR, p.Thumb.START), this.adapter.addThumbClass(u.cssClasses.THUMB_WITH_INDICATOR, p.Thumb.END))
            }, y.prototype.handleThumbMouseleave = function() {
                var t, e;
                this.isDiscrete && this.isRange && ((null === (e = (t = this.adapter).shouldHideFocusStylesForPointerEvents) || void 0 === e || !e.call(t)) && (this.adapter.isInputFocused(p.Thumb.START) || this.adapter.isInputFocused(p.Thumb.END)) || this.thumb || (this.adapter.removeThumbClass(u.cssClasses.THUMB_WITH_INDICATOR, p.Thumb.START), this.adapter.removeThumbClass(u.cssClasses.THUMB_WITH_INDICATOR, p.Thumb.END)))
                ...
                0 === t.button && (null != t.pointerId && this.adapter.setPointerCapture(t.pointerId), this.adapter.registerEventHandler("pointermove", this.moveListener), this.handleDown(t))
                ...
                if (this.adapter.addThumbClass(u.cssClasses.THUMB_FOCUSED, t), this.isDiscrete && (this.adapter.addThumbClass(u.cssClasses.THUMB_WITH_INDICATOR, t), this.isRange)) {
                    var e = t === p.Thumb.START ? p.Thumb.END : p.Thumb.START;
                    this.adapter.addThumbClass(u.cssClasses.THUMB_WITH_INDICATOR, e)
                }
            }, y.prototype.handleInputBlur = function(t) {
                if (this.adapter.removeThumbClass(u.cssClasses.THUMB_FOCUSED, t), this.isDiscrete && (this.adapter.removeThumbClass(u.cssClasses.THUMB_WITH_INDICATOR, t), this.isRange)) {
                    var e = t === p.Thumb.START ? p.Thumb.END : p.Thumb.START;
                    this.adapter.removeThumbClass(u.cssClasses.THUMB_WITH_INDICATOR, e)
                }
            }, y.prototype.handleDragStart = function(t, e, n) {
                var i, r;
                this.adapter.emitDragStartEvent(e, n), this.adapter.focusInput(n), (null === (r = (i = this.adapter).shouldHideFocusStylesForPointerEvents) || void 0 === r ? void 0 : r.call(i)) && this.handleInputFocus(n), t.preventDefault()
                ...
                return Math.abs(this.downEventClientX - t) < u.numbers.THUMB_UPDATE_MIN_PX ? this.thumb : t < this.downEventClientX ? this.adapter.isRTL() ? p.Thumb.END : p.Thumb.START : this.adapter.isRTL() ? p.Thumb.START : p.Thumb.END
            }, y.prototype.updateUI = function(t) {
                t ? this.updateThumbAndInputAttributes(t) : (this.updateThumbAndInputAttributes(p.Thumb.START), this.updateThumbAndInputAttributes(p.Thumb.END)), this.updateThumbAndTrackUI(t), this.updateValueIndicatorUI(t), this.updateTickMarksUI()
            }, y.prototype.updateThumbAndInputAttributes = function(t) {
                if (t) {
                    var e = this.isRange && t === p.Thumb.START ? this.valueStart : this.value,
                        n = String(e);
                    this.adapter.setInputAttribute(u.attributes.INPUT_VALUE, n, t), this.isRange && t === p.Thumb.START ? this.adapter.setInputAttribute(u.attributes.INPUT_MIN, String(e + this.minRange), p.Thumb.END) : this.isRange && t === p.Thumb.END && this.adapter.setInputAttribute(u.attributes.INPUT_MAX, String(e - this.minRange), p.Thumb.START), this.adapter.getInputValue(t) !== n && this.adapter.setInputValue(n, t);
                    var i = this.adapter.getValueToAriaValueTextFn();
                    i && this.adapter.setInputAttribute(u.attributes.ARIA_VALUETEXT, i(e, t), t)
                }
                ...
                if (this.isDiscrete && this.hasTickMarks) {
                    var t = (this.valueStart - this.min) / this.step,
                        ...
                        i = Array.from({
                            length: t
                        }).fill(p.TickMark.INACTIVE),
                        r = Array.from({
                            length: e
                        }).fill(p.TickMark.ACTIVE),
                        o = Array.from({
                            length: n
                        }).fill(p.TickMark.INACTIVE);
                ...
                return t = Math.min(Math.max(t, this.min), this.max), this.isRange && e === p.Thumb.START && t > this.value - this.minRange ? this.value - this.minRange : this.isRange && e === p.Thumb.END && t < this.valueStart + this.minRange ? this.valueStart + this.minRange : t
                ...
                if (this.isRange) {
                    ...
                    this.animFrame.request(l.SLIDER_UPDATE, function() {
                        !s && n === p.Thumb.START || s && n !== p.Thumb.START ? (i.adapter.setTrackActiveStyleProperty("transform-origin", "right"), i.adapter.setTrackActiveStyleProperty("left", "auto"), i.adapter.setTrackActiveStyleProperty("right", i.rect.width - u + "px")) : (i.adapter.setTrackActiveStyleProperty("transform-origin", "left"), i.adapter.setTrackActiveStyleProperty("right", "auto"), i.adapter.setTrackActiveStyleProperty("left", c + "px")), i.adapter.setTrackActiveStyleProperty(a, "scaleX(" + r + ")");
                        var t = s ? u : c,
                    ...
                    i.adapter.setThumbStyleProperty(a, "translateX(" + t + "px)", p.Thumb.END), i.alignValueIndicator(p.Thumb.END, t), i.adapter.setTrackActiveStyleProperty(a, "scaleX(" + r + ")"), i.removeInitialStyles(s)
                })
                ...
                var t = this;
                if (this.isDiscrete) {
                    var e = h ? d.getCorrectPropertyName(window, "transition") : "transition",
                        n = "none 0s ease 0s";
                ...
                var i = !1;
                if (this.adapter.isRTL()) i = t - this.startThumbKnobWidth / 2 <= e + this.endThumbKnobWidth / 2;
                else {
                    var r = t + this.startThumbKnobWidth / 2;
                    i = e - this.endThumbKnobWidth / 2 <= r
                }
                i ? (this.adapter.addThumbClass(u.cssClasses.THUMB_TOP, n || p.Thumb.END), this.adapter.removeThumbClass(u.cssClasses.THUMB_TOP, n === p.Thumb.START ? p.Thumb.END : p.Thumb.START)) : (this.adapter.removeThumbClass(u.cssClasses.THUMB_TOP, p.Thumb.START), this.adapter.removeThumbClass(u.cssClasses.THUMB_TOP, p.Thumb.END))
                ...
                if (this.isRange) {
                    if (i < e || n < i || r < e || n < r) throw new Error("MDCSliderFoundation: values must be in [min, max] range. Current values: [start value: " + r + ", end value: " + i + ", min: " + e + ", max: " + n + "]");
                    if (i < r) throw new Error("MDCSliderFoundation: start value must be <= end value. Current values: [start value: " + r + ", end value: " + i + "]");
                    if (s < 0) throw new Error("MDCSliderFoundation: minimum range must be non-negative. Current min range: " + s);
                    if (i - r < s) throw new Error("MDCSliderFoundation: start value and end value must differ by at least " + s + ". Current values: [start value: " + r + ", end value: " + i + "]");
                    var a = (r - e) / o,
                        c = (i - e) / o;
                    if (!Number.isInteger(parseFloat(a.toFixed(6))) || !Number.isInteger(parseFloat(c.toFixed(6)))) throw new Error("MDCSliderFoundation: Slider values must be valid based on the step value (" + o + "). Current values: [start value: " + r + ", end value: " + i + ", min: " + e + "]")
                } else {
                    if (i < e || n < i) throw new Error("MDCSliderFoundation: value must be in [min, max] range. Current values: [value: " + i + ", min: " + e + ", max: " + n + "]");
                    if (c = (i - e) / o, !Number.isInteger(parseFloat(c.toFixed(6)))) throw new Error("MDCSliderFoundation: Slider value must be valid based on the step value (" + o + "). Current value: " + i)
                }
        ...
        function y(t) {
            ...
            return e.initialStylesRemoved = !1, e.isDisabled = !1, e.isDiscrete = !1, e.step = u.numbers.STEP_SIZE, e.minRange = u.numbers.MIN_RANGE, e.hasTickMarks = !1, e.isRange = !1, e.thumb = null, e.downEventClientX = null, e.startThumbKnobWidth = 0, e.endThumbKnobWidth = 0, e.animFrame = new s.AnimationFrame, e
        }
        ...
        e.announce = function(t, e) {
            ...
            if (i && n) {
                ...
                r.setAttribute("style", "display: inline-block; width: 0; height: 1px;"), r.textContent = " ", e.appendChild(r), e.setAttribute(s, i), setTimeout(function() {
                    t.setAttribute("aria-live", n), e.removeAttribute(s), e.textContent = i
                }, o)
            }
        }
    }, function(t, e, n) {
        ...
        var s, a = n(0),
            ...
            f = (s = a.MDCFoundation, r(y, s), Object.defineProperty(y, "cssClasses", {
                get: function() {
                    return c.cssClasses
                },
                enumerable: !1,
                ...
                var e = this;
                this.clearAutoDismissTimer(), this.opened = !0, this.adapter.notifyOpening(), this.adapter.removeClass(d), this.adapter.addClass(u), this.adapter.announce(), this.runNextAnimationFrame(function() {
                    e.adapter.addClass(l), e.animationTimer = setTimeout(function() {
                        var t = e.getTimeoutMs();
                        e.handleAnimationTimerEnd(), e.adapter.notifyOpened(), t !== c.numbers.INDETERMINATE && (e.autoDismissTimer = setTimeout(function() {
                            e.close(h)
                        }, t))
                ...
                var e = this;
                void 0 === t && (t = ""), this.opened && (cancelAnimationFrame(this.animationFrame), this.animationFrame = 0, this.clearAutoDismissTimer(), this.opened = !1, this.adapter.notifyClosing(t), this.adapter.addClass(c.cssClasses.CLOSING), this.adapter.removeClass(c.cssClasses.OPEN), this.adapter.removeClass(c.cssClasses.OPENING), clearTimeout(this.animationTimer), this.animationTimer = setTimeout(function() {
        ...
        function y(t) {
            ...
            return e.opened = !1, e.animationFrame = 0, e.animationTimer = 0, e.autoDismissTimer = 0, e.autoDismissTimeoutMs = c.numbers.DEFAULT_AUTO_DISMISS_TIMEOUT_MS, e.closeOnEscape = !0, e
        }
        ...
        var s, a = n(0),
            ...
            u = (s = a.MDCFoundation, r(l, s), Object.defineProperty(l, "strings", {
                ...
                var e = t.target;
                this.updateAriaChecked(e.checked), this.updateCheckedStyling(e.checked)
        ...
        var o, s = n(216),
            a = n(35),
            c = (o = s.MDCObserverFoundation, r(u, o), u.prototype.init = function() {
        ...
        var l, d = (r(p, l = c), p.prototype.init = function() {
            l.prototype.init.call(this), this.observe(this.adapter.state, {
                disabled: this.onDisabledChange,
                processing: this.onProcessingChange,
                selected: this.onSelectedChange
            })
        }, p.prototype.initFromDOM = function() {
            this.setObserversEnabled(this.adapter.state, !1), this.adapter.state.selected = this.adapter.hasClass(a.CssClasses.SELECTED), this.onSelectedChange(), this.adapter.state.disabled = this.adapter.isDisabled(), this.adapter.state.processing = this.adapter.hasClass(a.CssClasses.PROCESSING), this.setObserversEnabled(this.adapter.state, !0), this.stopProcessingIfDisabled()
        ...
        var c, u = n(1),
            ...
            p = n(99),
            h = a(n(100)),
            f = (c = u.MDCComponent, r(y, c), y.attachTo = function(t) {
                return new y(t)
            }, y.prototype.initialize = function() {
                this.area = this.root.querySelector(p.MDCTabScrollerFoundation.strings.AREA_SELECTOR), this.content = this.root.querySelector(p.MDCTabScrollerFoundation.strings.CONTENT_SELECTOR)
            }, y.prototype.initialSyncWithDOM = function() {
                var e = this;
                ...
                var n = this,
                    t = {
                        ...
                        getScrollContentStyleValue: function(t) {
                            return window.getComputedStyle(n.content).getPropertyValue(t)
                        },
        ...
        var a, c = n(0),
            ...
            h = (a = c.MDCFoundation, r(f, a), Object.defineProperty(f, "cssClasses", {
                ...
                var e = t.target;
                this.isAnimating && this.adapter.eventTargetMatchesSelector(e, f.strings.CONTENT_SELECTOR) && (this.isAnimating = !1, this.adapter.removeClass(f.cssClasses.ANIMATING))
                ...
                if (0 !== t) {
                    ...
                    0 !== e.scrollDelta && (this.stopScrollAnimation(), this.adapter.setScrollAreaScrollLeft(e.finalScrollPosition))
                }
                ...
                if (this.isRTL()) return this.getRTLScroller().incrementScrollRTL(t);
                var e = this.getScrollPosition(),
                    n = t + e,
                ...
                var e = this;
                0 !== t.scrollDelta && (this.stopScrollAnimation(), this.adapter.setScrollAreaScrollLeft(t.finalScrollPosition), this.adapter.setScrollContentStyleProperty("transform", "translateX(" + t.scrollDelta + "px)"), this.adapter.computeScrollAreaClientRect(), requestAnimationFrame(function() {
                ...
                return this.isRTL() ? this.getRTLScroller().getAnimatingScrollPosition(e, t) : e - t
        ...
        var o, s = n(1),
            ...
            d = (o = s.MDCComponent, r(p, o), p.attachTo = function(t) {
                ...
                this.tabIndicator = e(i), this.content = this.root.querySelector(l.MDCTabFoundation.strings.CONTENT_SELECTOR)
            }, p.prototype.initialSyncWithDOM = function() {
                var t = this;
                this.handleClick = function() {
                    t.foundation.handleClick()
                ...
                var n = this,
                    t = {
                        ...
                        notifyInteracted: function() {
                            return n.emit(l.MDCTabFoundation.strings.INTERACTED_EVENT, {
                                tabId: n.id
                            }, !0)
                        },
                        getOffsetLeft: function() {
        ...
        var l, d = (l = s.MDCFoundation, r(p, l), Object.defineProperty(p, "strings", {
            ...
            this.indexIsInRange(t) && t !== n && (-1 !== n && (this.adapter.deactivateTabAtIndex(n), e = this.adapter.getTabIndicatorClientRectAtIndex(n)), this.adapter.activateTabAtIndex(t, e), this.scrollIntoView(t), this.adapter.notifyTabActivated(t))
        }, p.prototype.handleKeyDown = function(t) {
            var e = this.getKeyFromEvent(t);
            if (void 0 !== e)
                if (this.isActivationKey(e) || t.preventDefault(), this.useAutomaticActivation) {
                    if (this.isActivationKey(e)) return;
                    var n = this.determineTargetFromKey(this.adapter.getPreviousActiveTabIndex(), e);
                    this.adapter.setActiveTab(n), this.scrollIntoView(n)
                } else {
                    var i = this.adapter.getFocusedTabIndex();
                    this.isActivationKey(e) ? this.adapter.setActiveTab(i) : (n = this.determineTargetFromKey(i, e), this.adapter.focusTabAtIndex(n), this.scrollIntoView(n))
                }
            ...
            this.indexIsInRange(t) && (0 !== t ? t !== this.adapter.getTabListLength() - 1 ? this.isRTL() ? this.scrollIntoViewImplRTL(t) : this.scrollIntoViewImpl(t) : this.adapter.scrollTo(this.adapter.getScrollContentWidth()) : this.adapter.scrollTo(0))
        ...
        }, p.prototype.calculateScrollIncrementRTL = function(t, e, n, i, r) {
        ...
        }, p.prototype.findAdjacentTabIndexClosestToEdge = function(t, e, n, i) {
            var r = e.rootLeft - n,
                o = e.rootRight - n - i,
                s = r + o;
            return r < 0 || s < 0 ? t - 1 : 0 < o || 0 < s ? t + 1 : -1
        }, p.prototype.findAdjacentTabIndexClosestToEdgeRTL = function(t, e, n, i, r) {
        ...
        var s, a = n(0),
            ...
            d = ["click", "keydown"],
            p = (s = a.MDCFoundation, r(h, s), Object.defineProperty(h, "cssClasses", {
                get: function() {
                    return c.cssClasses
                },
                enumerable: !1,
                ...
                try {
                    for (var a = u(d), c = a.next(); !c.done; c = a.next()) s = c.value, this.adapter.registerTextFieldInteractionHandler(s, this.textFieldInteractionHandler)
                } catch (t) {
                    n = {
                        error: t
                    }
                ...
                try {
                    for (var a = u(d), c = a.next(); !c.done; c = a.next()) s = c.value, this.adapter.deregisterTextFieldInteractionHandler(s, this.textFieldInteractionHandler)
                } catch (t) {
                    n = {
                        error: t
                    }
                ...
                var e = this;
                t.some(function(t) {
                    return -1 < c.VALIDATION_ATTR_WHITELIST.indexOf(t) && (e.styleValidity(!0), e.adapter.setLabelRequired(e.getNativeInput().required), !0)
                }), -1 < t.indexOf("maxlength") && this.setcharacterCounter(this.getValue().length)
                ...
                var e = h.cssClasses,
                    n = e.DISABLED,
                    i = e.INVALID;
                t ? (this.adapter.addClass(n), this.adapter.removeClass(i)) : this.adapter.removeClass(n), this.leadingIcon && this.leadingIcon.setDisabled(t), this.trailingIcon && this.trailingIcon.setDisabled(t)
        ...
        var i, r = this && this.__extends || (i = function(t, e) {
            ...
            T = this && this.__values || function(t) {
                var e = "function" == typeof Symbol && Symbol.iterator,
                    n = e && t[e],
                    i = 0;
                if (n) return n.call(t);
        ...
        var g, _ = "undefined" != typeof window,
            m = (g = c.MDCFoundation, r(v, g), Object.defineProperty(v, "defaultAdapter", {
                get: function() {
                    return {
                        getAttribute: function() {
                            return null
                ...
                if (u.normalizeKey(t) === u.KEY.ESCAPE) {
                    ...
                    e instanceof HTMLElement && this.adapter.tooltipContainsElement(e) && this.adapter.focusAnchorElement(), this.hide()
                }
            }, v.prototype.handleAnchorBlur = function(t) {
                if (this.richTooltip) {
                    if (t.relatedTarget instanceof HTMLElement && this.adapter.tooltipContainsElement(t.relatedTarget)) return;
                    if (null === t.relatedTarget && this.interactiveTooltip) return
                }
                this.hide()
                ...
                t.relatedTarget instanceof HTMLElement && (this.adapter.anchorContainsElement(t.relatedTarget) || this.adapter.tooltipContainsElement(t.relatedTarget)) || null === t.relatedTarget && this.interactiveTooltip || this.hide()
                ...
                if (this.clearHideTimeout(), this.clearShowTimeout(), !this.tooltipShown) {
                    ...
                    try {
                        for (var i = T(this.addAncestorScrollEventListeners), r = i.next(); !r.done; r = i.next())(0, r.value)()
                    } catch (t) {
                        e = {
                            error: t
                        }
                    ...
                    this.frameId = requestAnimationFrame(function() {
                        n.clearAllAnimationClasses(), n.adapter.addClass(d), n.adapter.addClass(f)
                    })
                }
                ...
                if (this.clearHideTimeout(), this.clearShowTimeout(), this.tooltipShown) {
                    ...
                    try {
                        for (var n = T(this.removeAncestorScrollEventListeners), i = n.next(); !i.done; i = n.next())(0, i.value)()
                    } catch (t) {
                        e = {
                            error: t
                        }
                ...
                this.adapter.removeClass(p), this.adapter.removeClass(f), this.adapter.removeClass(y), this.adapter.removeClass(C), t && null === this.showTimeout && this.adapter.notifyHidden()
                ...
                t === b.AnchorBoundaryType.UNBOUNDED ? this.anchorGap = b.numbers.UNBOUNDED_ANCHOR_GAP : this.anchorGap = b.numbers.BOUNDED_ANCHOR_GAP
                ...
                return t.height > b.numbers.MIN_HEIGHT && t.width >= b.numbers.MAX_WIDTH
                ...
                var t = this.calculateTooltipStyles(this.anchorRect),
                    ...
                    o = _ ? h.getCorrectPropertyName(window, "transform") : "transform";
                this.adapter.setSurfaceAnimationStyleProperty(o + "-origin", r + " " + n), this.adapter.setStyleProperty("top", e + "px"), this.adapter.setStyleProperty("left", i + "px")
                ...
                var o = this.hasCaret ? this.calculateTooltipWithCaretStyles(this.anchorRect) : this.calculateTooltipStyles(this.anchorRect),
                    s = o.top,
                    a = o.yTransformOrigin,
                    c = o.left,
                    u = o.xTransformOrigin,
                    l = _ ? h.getCorrectPropertyName(window, "transform") : "transform";
                this.adapter.setSurfaceAnimationStyleProperty(l + "-origin", u + " " + a);
                ...
                s = this.richTooltip ? (n = a ? t.left - e : t.right, i = a ? t.right : t.left - e, o = a ? b.strings.RIGHT : b.strings.LEFT, a ? b.strings.LEFT : b.strings.RIGHT) : (n = a ? t.left : t.right - e, i = a ? t.right - e : t.left, r = t.left + (t.width - e) / 2, o = a ? b.strings.LEFT : b.strings.RIGHT, a ? b.strings.RIGHT : b.strings.LEFT);
                var c = this.richTooltip ? this.determineValidPositionOptions(n, i) : this.determineValidPositionOptions(r, n, i);
                if (this.xTooltipPos === b.XPosition.START && c.has(n)) return {
                    distance: n,
                    xTransformOrigin: o
                };
                if (this.xTooltipPos === b.XPosition.END && c.has(i)) return {
                    distance: i,
                    xTransformOrigin: s
                };
                if (this.xTooltipPos === b.XPosition.CENTER && c.has(r)) return {
                    distance: r,
                    xTransformOrigin: b.strings.CENTER
                };
                var u = (this.richTooltip ? [{
                    distance: i,
                    xTransformOrigin: s
                }, {
                    distance: n,
                ...
                return this.yTooltipPos === b.YPosition.ABOVE && r.has(i) ? {
                    distance: i,
                    yTransformOrigin: b.strings.BOTTOM
                } : this.yTooltipPos === b.YPosition.BELOW && r.has(n) ? {
                    distance: n,
                    yTransformOrigin: b.strings.TOP
                } : r.has(n) ? {
                    distance: n,
                    yTransformOrigin: b.strings.TOP
                } : r.has(i) ? {
                ...
                a.size < 1 && (a = this.generateBackupPositionOption(t, r, {
                    caretWidth: n,
                    caretHeight: i
                }));
            ...
            }, v.prototype.calculateXWithCaretDistanceOptions = function(t, e, n) {
                var i = n.caretWidth,
                    r = n.caretHeight,
            ...
            }, v.prototype.calculateYWithCaretDistanceOptions = function(t, e, n) {
                var i = n.caretWidth,
                    r = n.caretHeight,
                    o = t.top + t.height / 2,
                ...
                var n, i, r, o, s, a, c = new Map,
                    u = new Map,
                    l = new Map([
                        [b.YPositionWithCaret.ABOVE, [b.XPositionWithCaret.START, b.XPositionWithCaret.CENTER, b.XPositionWithCaret.END]],
                        [b.YPositionWithCaret.BELOW, [b.XPositionWithCaret.START, b.XPositionWithCaret.CENTER, b.XPositionWithCaret.END]],
                        [b.YPositionWithCaret.SIDE_TOP, [b.XPositionWithCaret.SIDE_START, b.XPositionWithCaret.SIDE_END]],
                        [b.YPositionWithCaret.SIDE_CENTER, [b.XPositionWithCaret.SIDE_START, b.XPositionWithCaret.SIDE_END]],
                        [b.YPositionWithCaret.SIDE_BOTTOM, [b.XPositionWithCaret.SIDE_START, b.XPositionWithCaret.SIDE_END]]
                    ]);
                try {
                    for (var d = T(l.keys()), p = d.next(); !p.done; p = d.next()) {
                        var h = p.value,
                            f = t.get(h);
                        if (this.yPositionHonorsViewportThreshold(f)) try {
                            for (var y = (r = void 0, T(l.get(h))), C = y.next(); !C.done; C = y.next()) {
                                var E = C.value,
                                    g = e.get(E);
                        ...
                        if (this.yPositionDoesntCollideWithViewport(f)) try {
                            for (var m = (s = void 0, T(l.get(h))), v = m.next(); !v.done; v = m.next()) E = v.value, g = e.get(E), this.positionDoesntCollideWithViewport(g) && (_ = this.caretPositionOptionsMapping(E, h), u.set(_, {
                                xDistance: g,
                                yDistance: f
                            }))
                        } catch (t) {
                ...
                var i, r, o, s, a = !this.adapter.isRTL();
                r = t.left < 0 ? (i = this.minViewportTooltipThreshold + n.caretHeight, a ? b.XPositionWithCaret.END : b.XPositionWithCaret.START) : (i = this.adapter.getViewportWidth() - (e.width + this.minViewportTooltipThreshold + n.caretHeight), a ? b.XPositionWithCaret.START : b.XPositionWithCaret.END), s = t.top < 0 ? (o = this.minViewportTooltipThreshold + n.caretHeight, b.YPositionWithCaret.BELOW) : (o = this.adapter.getViewportHeight() - (e.height + this.minViewportTooltipThreshold + n.caretHeight), b.YPositionWithCaret.ABOVE);
                ...
                var n = [b.PositionWithCaret.ABOVE_START, b.PositionWithCaret.ABOVE_CENTER, b.PositionWithCaret.ABOVE_END, b.PositionWithCaret.TOP_SIDE_START, b.PositionWithCaret.CENTER_SIDE_START, b.PositionWithCaret.BOTTOM_SIDE_START, b.PositionWithCaret.TOP_SIDE_END, b.PositionWithCaret.CENTER_SIDE_END, b.PositionWithCaret.BOTTOM_SIDE_END, b.PositionWithCaret.BELOW_START, b.PositionWithCaret.BELOW_CENTER, b.PositionWithCaret.BELOW_END].find(function(t) {
                        return e.has(t)
                    }),
                    i = e.get(n);
                return {
                ...
                switch (e) {
                    case b.YPositionWithCaret.ABOVE:
                        if (t === b.XPositionWithCaret.START) return b.PositionWithCaret.ABOVE_START;
                        if (t === b.XPositionWithCaret.CENTER) return b.PositionWithCaret.ABOVE_CENTER;
                        if (t === b.XPositionWithCaret.END) return b.PositionWithCaret.ABOVE_END;
                        break;
                    case b.YPositionWithCaret.BELOW:
                        if (t === b.XPositionWithCaret.START) return b.PositionWithCaret.BELOW_START;
                        if (t === b.XPositionWithCaret.CENTER) return b.PositionWithCaret.BELOW_CENTER;
                        if (t === b.XPositionWithCaret.END) return b.PositionWithCaret.BELOW_END;
                        break;
                    case b.YPositionWithCaret.SIDE_TOP:
                        if (t === b.XPositionWithCaret.SIDE_START) return b.PositionWithCaret.TOP_SIDE_START;
                        if (t === b.XPositionWithCaret.SIDE_END) return b.PositionWithCaret.TOP_SIDE_END;
                        break;
                    case b.YPositionWithCaret.SIDE_CENTER:
                        if (t === b.XPositionWithCaret.SIDE_START) return b.PositionWithCaret.CENTER_SIDE_START;
                        if (t === b.XPositionWithCaret.SIDE_END) return b.PositionWithCaret.CENTER_SIDE_END;
                        break;
                    case b.YPositionWithCaret.SIDE_BOTTOM:
                        if (t === b.XPositionWithCaret.SIDE_START) return b.PositionWithCaret.BOTTOM_SIDE_START;
                        if (t === b.XPositionWithCaret.SIDE_END) return b.PositionWithCaret.BOTTOM_SIDE_END
                }
                throw new Error("MDCTooltipFoundation: Invalid caret position of " + t + ", " + e)
            }, v.prototype.setCaretPositionStyles = function(t, e) {
                var n, i, r = this.calculateCaretPositionOnTooltip(t, e);
                if (!r) return {
                    yTransformOrigin: 0,
                    xTransformOrigin: 0
                };
                this.adapter.clearTooltipCaretStyles(), this.adapter.setTooltipCaretStyle(r.yAlignment, r.yAxisPx), this.adapter.setTooltipCaretStyle(r.xAlignment, r.xAxisPx);
                var o = r.skew * (Math.PI / 180),
                    s = Math.cos(o);
                this.adapter.setTooltipCaretStyle("transform", "rotate(" + r.rotation + "deg) skewY(" + r.skew + "deg) scaleX(" + s + ")"), this.adapter.setTooltipCaretStyle("transform-origin", r.xAlignment + " " + r.yAlignment);
                try {
                    for (var a = T(r.caretCorners), c = a.next(); !c.done; c = a.next()) {
                        var u = c.value;
                ...
                if (i && r && e) {
                    var o = "calc((" + i + " - " + e.caretWidth + "px) / 2)",
                        ...
                        u = "calc(" + r + " - " + a + ")",
                        l = Math.abs(55),
                        d = ["border-bottom-right-radius", "border-top-left-radius"],
        ...
        var o, s = n(9),
            ...
            c = (o = a.MDCTopAppBarFoundation, r(u, o), u.prototype.handleTargetScroll = function() {
                this.adapter.getViewportScrollY() <= 0 ? this.wasScrolled && (this.adapter.removeClass(s.cssClasses.FIXED_SCROLLED_CLASS), this.wasScrolled = !1) : this.wasScrolled || (this.adapter.addClass(s.cssClasses.FIXED_SCROLLED_CLASS), this.wasScrolled = !0)
            }, u);
        ...
        var o, s = n(9),
            ...
            c = (o = a.MDCTopAppBarBaseFoundation, r(u, o), Object.defineProperty(u.prototype, "isCollapsed", {
                ...
                this.adapter.removeClass(s.cssClasses.SHORT_COLLAPSED_CLASS), this.collapsed = !1
            }, u.prototype.collapse = function() {
                this.adapter.addClass(s.cssClasses.SHORT_COLLAPSED_CLASS), this.collapsed = !0
            }, u);
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.topAppBar = e.tooltip = e.textField = e.tabScroller = e.tabIndicator = e.tabBar = e.tab = e.switchControl = e.snackbar = e.slider = e.select = e.segmentedButton = e.ripple = e.radio = e.notchedOutline = e.menuSurface = e.menu = e.list = e.linearProgress = e.lineRipple = e.iconButton = e.formField = e.floatingLabel = e.drawer = e.dom = e.dialog = e.dataTable = e.circularProgress = e.chips = e.checkbox = e.base = e.banner = e.autoInit = void 0;
        var a = s(n(121));
        ...
        function o(t) {
            ...
            var i = y[t];
            i && n("(mdc-auto-init) Overriding registration for " + t + " with " + e + ". Was: " + i), y[t] = e
        }, o.deregister = function(t) {
            delete y[t]
        }, o.deregisterAll = function() {
            var e, t;
            try {
                for (var n = d(Object.keys(y)), i = n.next(); !i.done; i = n.next()) {
                    var r = i.value;
                    o.deregister(r)
                }
            } catch (t) {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(124), e), r(n(125), e), r(n(18), e), r(n(45), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var o, s = n(1),
            ...
            d = (o = s.MDCComponent, r(p, o), p.attachTo = function(t) {
                ...
                this.registerContentClickHandler(this.handleContentClick), this.focusTrap = this.focusTrapFactory(this.root, {
                ...
                var n = this,
                    t = {
                        ...
                        notifyClosed: function(t) {
                            n.emit(u.events.CLOSED, {
                                reason: t
                            })
                        },
                        notifyClosing: function(t) {
                            n.emit(u.events.CLOSING, {
                                reason: t
                            })
                        },
                        notifyOpened: function() {
                        ...
                        notifyActionClicked: function(t) {
                            n.emit(u.events.ACTION_CLICKED, {
                                action: t
                            })
                        },
                        releaseFocus: function() {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(129), e), r(n(46), e), r(n(20), e), r(n(48), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.trailingActionStrings = void 0, r(n(132), e), r(n(49), e), r(n(50), e), r(n(133), e);
        var o = n(12);
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.chipStrings = e.chipCssClasses = void 0, r(n(135), e), r(n(51), e), r(n(21), e), r(n(136), e);
        var o = n(13);
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.chipSetStrings = e.chipSetCssClasses = void 0, r(n(138), e), r(n(139), e), r(n(52), e);
        var o = n(53);
        ...
        var o, a = n(1),
            ...
            g = 0,
            _ = (o = a.MDCComponent, r(m, o), m.attachTo = function(t) {
                return new m(t)
                ...
                var e, t, n = this;
                try {
                    for (var i = s(this.chipsList), r = i.next(); !r.done; r = i.next()) {
                        var o = r.value;
                ...
                var e, t;
                try {
                    for (var n = s(this.chipsList), i = n.next(); !i.done; i = n.next()) i.value.destroy()
                } catch (t) {
                    e = {
                        error: t
                    }
                ...
                t.id = t.id || "mdc-chip-" + ++g, this.chipsList.push(this.chipFactory(t))
                ...
                var i = this,
                    t = {
                        ...
                        removeChipAtIndex: function(t) {
                            0 <= t && t < i.chips.length && (i.chipsList[t].destroy(), i.chipsList[t].remove(), i.chipsList.splice(t, 1))
                        },
                        removeFocusFromChipAtIndex: function(t) {
                            i.chipsList[t].removeFocus()
                        },
                        selectChipAtIndex: function(t, e, n) {
                            0 <= t && t < i.chips.length && i.chipsList[t].setSelectedFromChipSet(e, n)
                        }
                    };
                return new d.MDCChipSetFoundation(t)
            }, m.prototype.instantiateChips = function(e) {
                return [].slice.call(this.root.querySelectorAll(E)).map(function(t) {
        ...
        Object.defineProperty(i, "__esModule", {
            value: !0
        }), i.announce = i.DATA_MDC_DOM_ANNOUNCE = i.AnnouncerPriority = void 0, (n = c = i.AnnouncerPriority || (i.AnnouncerPriority = {})).POLITE = "polite", n.ASSERTIVE = "assertive", i.DATA_MDC_DOM_ANNOUNCE = "data-mdc-dom-announce", i.announce = function(t, e) {
            r.getInstance().say(t, e)
        };
        var r = (o.getInstance = function() {
            return o.instance || (o.instance = new o), o.instance
        }, o.prototype.say = function(t, e) {
            var n, i, r = null !== (n = null == e ? void 0 : e.priority) && void 0 !== n ? n : c.POLITE,
                o = null !== (i = null == e ? void 0 : e.ownerDocument) && void 0 !== i ? i : document,
            ...
            return n.style.position = "absolute", n.style.top = "-9999px", n.style.left = "-9999px", n.style.height = "1px", n.style.overflow = "hidden", n.setAttribute("aria-atomic", "true"), n.setAttribute("aria-live", t), n.setAttribute(i.DATA_MDC_DOM_ANNOUNCE, "true"), e.body.appendChild(n), n
        }, o);
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(142), e), r(n(143), e), r(n(55), e), r(n(54), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var o, s = n(1),
            a = n(54),
            c = (o = s.MDCComponent, r(u, o), u.prototype.initialize = function() {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(145), e), r(n(146), e), r(n(59), e), r(n(22), e), r(n(147), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var s, a = n(1),
            ...
            h = (s = a.MDCComponent, r(f, s), f.attachTo = function(t) {
                ...
                }, this.headerRow.addEventListener("click", this.headerRowClickListener), this.content = this.root.querySelector("." + d.cssClasses.CONTENT), this.handleContentClick = function(t) {
                    var e = u.closest(t.target, d.selectors.ROW);
                    e && n.foundation.handleRowClick({
                        rowId: n.getRowIdByRowElement(e),
                        row: e
                    })
                }, this.content.addEventListener("click", this.handleContentClick), this.handleRowCheckboxChange = function(t) {
        ...
        var a = o(n(60));
        e.util = a, s(n(149), e), s(n(150), e), s(n(62), e), s(n(61), e), s(n(151), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var u, l = n(1),
            ...
            E = (u = l.MDCComponent, r(g, u), Object.defineProperty(g.prototype, "isOpen", {
                get: function() {
                    return this.foundation.isOpen()
                },
                enumerable: !1,
                ...
                if (!i) throw new Error("Dialog component requires a " + C.CONTAINER_SELECTOR + " container element");
                this.container = i, this.content = this.root.querySelector(C.CONTENT_SELECTOR), this.buttons = [].slice.call(this.root.querySelectorAll(C.BUTTON_SELECTOR)), this.defaultButton = this.root.querySelector("[" + C.BUTTON_DEFAULT_ATTRIBUTE + "]"), this.focusTrapFactory = t, this.buttonRipples = [];
                try {
                ...
                this.unlisten("click", this.handleClick), this.unlisten("keydown", this.handleKeydown), this.unlisten(C.OPENING_EVENT, this.handleOpening), this.unlisten(C.CLOSING_EVENT, this.handleClosing), this.handleClosing(), this.buttonRipples.forEach(function(t) {
                    t.destroy()
                ...
                var n = this,
                    t = {
                        ...
                        clickDefaultButton: function() {
                            n.defaultButton && !n.defaultButton.disabled && n.defaultButton.click()
                        },
                        ...
                        getActionFromEvent: function(t) {
                            if (!t.target) return "";
                            var e = p.closest(t.target, "[" + C.ACTION_ATTRIBUTE + "]");
                        ...
                        notifyClosed: function(t) {
                            return n.emit(C.CLOSED_EVENT, t ? {
                                action: t
                            } : {})
                        },
                        notifyClosing: function(t) {
                            return n.emit(C.CLOSING_EVENT, t ? {
                                action: t
                            } : {})
                        },
                        notifyOpened: function() {
        ...
        var a = o(n(63));
        e.util = a, s(n(154), e), s(n(155), e), s(n(65), e), s(n(26), e), s(n(66), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var c, u = n(1),
            ...
            E = (c = u.MDCComponent, r(g, c), g.attachTo = function(t) {
                return new g(t)
                ...
                n && (this.innerList = e(n), this.innerList.wrapFocus = !0), this.focusTrapFactory = t
            }, g.prototype.initialSyncWithDOM = function() {
                var e = this,
                    t = y.MODAL,
                    n = C.SCRIM_SELECTOR;
                ...
                }, this.scrim.addEventListener("click", this.handleScrimClick), this.focusTrap = f.createFocusTrapInstance(this.root, this.focusTrapFactory)), this.handleKeydown = function(t) {
                    e.foundation.handleKeydown(t)
                }, this.handleTransitionEnd = function(t) {
                    e.foundation.handleTransitionEnd(t)
                ...
                var t = y.MODAL;
                this.scrim && this.handleScrimClick && this.root.classList.contains(t) && (this.scrim.removeEventListener("click", this.handleScrimClick), this.open = !1)
            }, g.prototype.getDefaultFoundation = function() {
                var e = this,
                    t = {
                        addClass: function(t) {
                        ...
                        focusActiveNavigationItem: function() {
                            var t = e.root.querySelector(C.LIST_ITEM_ACTIVATED_SELECTOR);
                            t && t.focus()
                        },
                        notifyClose: function() {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.handleKeydown = e.clearBuffer = e.isTypingInProgress = e.matchItem = e.initSortedIndex = e.initState = void 0;
        var C = n(6),
            u = n(7),
            E = n(64);
        ...
        e.initState = function() {
        ...
        }, e.matchItem = g, e.isTypingInProgress = _, e.clearBuffer = l, e.handleKeydown = function(t, e) {
            var n = t.event,
            ...
            return n.altKey || n.ctrlKey || n.metaKey || c || u || l || d || p || h || f ? -1 : y || 1 !== n.key.length ? y ? (i && E.preventDefaultEvent(n), i && _(e) ? g({
                focusItemAtIndex: o,
                focusedItemIndex: r,
                nextChar: " ",
            ...
            }, e) : -1) : -1 : (E.preventDefaultEvent(n), g({
                focusItemAtIndex: o,
                focusedItemIndex: r,
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(158), e), r(n(27), e), r(n(67), e), r(n(28), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(160), e), r(n(161), e), r(n(69), e), r(n(68), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(163), e), r(n(164), e), r(n(71), e), r(n(70), e), r(n(165), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(167), e), r(n(29), e), r(n(73), e), r(n(72), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(169), e), r(n(56), e), r(n(58), e), r(n(57), e), r(n(170), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(172), e), r(n(24), e), r(n(7), e), r(n(25), e), r(n(173), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(175), e), r(n(74), e), r(n(8), e), r(n(14), e), r(n(176), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        }), r(n(178), e), r(n(75), e), r(n(15), e), r(n(76), e), r(n(179), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(181), e), r(n(30), e), r(n(31), e), r(n(77), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(183), e), r(n(184), e), r(n(79), e), r(n(78), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
            ...
            p = (s = a.MDCComponent, r(h, s), h.attachTo = function(t) {
                ...
                var n = this,
                    t = o(o({}, u.MDCRipple.createAdapter(this)), {
                        ...
                        deregisterInteractionHandler: function(t, e) {
                            n.nativeControl.removeEventListener(t, e, c.applyPassive())
                        },
                        isSurfaceActive: function() {
                            return !1
                        },
        ...
        var a = o(n(19));
        e.util = a, s(n(186), e), s(n(2), e), s(n(47), e), s(n(4), e), s(n(187), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var s, a = n(1),
            ...
            d = (s = a.MDCComponent, r(p, s), p.attachTo = function(t) {
                ...
                }), this.segmentFactory = t, this.segmentsList = this.instantiateSegments(this.segmentFactory)
            }, p.prototype.instantiateSegments = function(e) {
                return [].slice.call(this.root.querySelectorAll(u.selectors.SEGMENT)).map(function(t) {
                    return e(t)
                })
            }, p.prototype.initialSyncWithDOM = function() {
                var e = this;
                ...
                for (var t = this.foundation.isSingleSelect(), n = 0; n < this.segmentsList.length; n++) {
                ...
                if (t && 0 === r.length && 0 < this.segmentsList.length) throw new Error("No segment selected in singleSelect mdc-segmented-button");
                if (t && 1 < r.length) throw new Error("Multiple segments selected in singleSelect mdc-segmented-button")
            }, p.prototype.destroy = function() {
                var e, t;
                try {
                    for (var n = o(this.segmentsList), i = n.next(); !i.done; i = n.next()) i.value.destroy()
                } catch (t) {
                    e = {
                        error: t
                    }
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(196), e), r(n(197), e), r(n(32), e), r(n(85), e), r(n(198), e), r(n(199), e), r(n(201), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var u, l = n(1),
            ...
            v = n(86),
            T = n(89),
            b = (u = l.MDCComponent, r(A, u), A.attachTo = function(t) {
                return new A(t)
                ...
                if (this.selectAnchor.hasAttribute(_.strings.ARIA_CONTROLS)) {
                    var s = document.getElementById(this.selectAnchor.getAttribute(_.strings.ARIA_CONTROLS));
                ...
                var l = this.root.querySelector(_.strings.LEADING_ICON_SELECTOR);
                l && (this.leadingIcon = r(l)), this.root.classList.contains(_.cssClasses.OUTLINED) || (this.ripple = this.createRipple())
                ...
                this.menuElement = this.root.querySelector(_.strings.MENU_SELECTOR), this.menu = t(this.menuElement), this.menu.hasTypeahead = !0, this.menu.singleSelection = !0, this.menuItemValues = this.menu.items.map(function(t) {
                    return t.getAttribute(_.strings.VALUE_ATTR) || ""
                })
            }, A.prototype.createRipple = function() {
                var n = this,
                    t = o(o({}, E.MDCRipple.createAdapter({
                ...
                return new E.MDCRipple(this.selectAnchor, new g.MDCRippleFoundation(t))
                ...
                return {
                    ...
                    getAnchorElement: function() {
                        return n.root.querySelector(_.strings.SELECT_ANCHOR_SELECTOR)
                    },
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.helperTextStrings = e.helperTextCssClasses = void 0, r(n(200), e), r(n(86), e), r(n(87), e);
        var o = n(88);
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.iconStrings = void 0, r(n(202), e), r(n(89), e), r(n(90), e);
        var o = n(91);
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(204), e), r(n(205), e), r(n(33), e), r(n(92), e), r(n(34), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var o, s = n(1),
            ...
            a = n(92),
            f = n(34),
            y = (o = s.MDCComponent, r(C, o), C.attachTo = function(t, e) {
                ...
                var i = this,
                    t = {
                        ...
                        getValueIndicatorContainerWidth: function(t) {
                            return i.getThumbEl(t).querySelector("." + h.cssClasses.VALUE_INDICATOR_CONTAINER).getBoundingClientRect().width
                        },
                        isRTL: function() {
                        ...
                        updateTickMarks: function(t) {
                            ...
                            if (e || ((e = document.createElement("div")).classList.add(h.cssClasses.TICK_MARKS_CONTAINER), i.root.querySelector("." + h.cssClasses.TRACK).appendChild(e)), t.length !== e.children.length) {
                        ...
                        emitChangeEvent: function(t, e) {
                            i.emit(h.events.CHANGE, {
                                value: t,
                                thumb: e
                            })
                        },
                        emitInputEvent: function(t, e) {
                            i.emit(h.events.INPUT, {
                                value: t,
                                thumb: e
                            })
                        },
        ...
        var a = o(n(93));
        e.util = a, s(n(207), e), s(n(208), e), s(n(16), e), s(n(94), e), s(n(209), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var c, u = n(1),
            ...
            T = (c = u.MDCComponent, r(b, c), b.attachTo = function(t) {
                return new b(t)
                ...
                var n = this;
                this.surfaceEl = this.root.querySelector(f), this.labelEl = this.root.querySelector(y), this.actionEl = this.root.querySelector(C), this.handleKeyDown = function(t) {
                    n.foundation.handleKeyDown(t)
                }, this.handleSurfaceClick = function(t) {
                    var e = t.target;
                    n.isActionButton(e) ? n.foundation.handleActionButtonClick(t) : n.isActionIcon(e) && n.foundation.handleActionIconClick(t)
        ...
        var a = o(n(211));
        e.deprecated = a, s(n(214), e), s(n(215), e), s(n(35), e), s(n(97), e)
    }, function(t, e, n) {
        "use strict";
        var i = this && this.__createBinding || (Object.create ? function(t, e, n, i) {
                void 0 === i && (i = n), Object.defineProperty(t, i, {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(212), e), r(n(213), e), r(n(96), e), r(n(95), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var c, u = n(1),
            ...
            h = n(4),
            f = n(95),
            y = (c = u.MDCComponent, r(C, c), C.attachTo = function(t) {
                return new C(t)
            }, C.prototype.destroy = function() {
                ...
                var n = this,
                    ...
                    e = o(o({}, p.MDCRipple.createAdapter(this)), {
                        ...
                        deregisterInteractionHandler: function(t, e) {
                            n.nativeControl.removeEventListener(t, e, l.applyPassive())
                        },
                        isSurfaceActive: function() {
        ...
        var s, a = n(1),
            ...
            p = (s = a.MDCComponent, r(h, s), h.attachTo = function(t) {
                ...
                if (!t) throw new Error("Switch " + l.Selectors.RIPPLE + " element is required.");
                this.rippleElement = t, this.root.addEventListener("click", this.foundation.handleClick), this.foundation.initFromDOM()
            }, h.prototype.destroy = function() {
        ...
        var a, c = n(0),
            u = n(217),
            l = (a = c.MDCFoundation, r(p, a), p.prototype.destroy = function() {
                a.prototype.destroy.call(this), this.unobserve()
            }, p.prototype.observe = function(t, e) {
                var n, i, r = this,
                    o = [];
                try {
                    for (var s = d(Object.keys(e)), a = s.next(); !a.done; a = s.next()) {
                        var c = a.value,
                            u = e[c].bind(this);
                ...
                function l() {
                    var e, t;
                    try {
                        for (var n = d(o), i = n.next(); !i.done; i = n.next())(0, i.value)()
                    } catch (t) {
                        e = {
                            error: t
                        }
                ...
                var e, t;
                try {
                    for (var n = d(s([], o(this.unobserves))), i = n.next(); !i.done; i = n.next())(0, i.value)()
                } catch (t) {
                    e = {
                        error: t
                    }
        ...
        function f(t, e, n) {
            var i = function(t, s) {
                ...
                u && (i.set = function(t) {
                    var e, n, i = c ? c.call(this) : t;
                    if (u.call(this, t), a.isEnabled && (!c || t !== i)) try {
                        for (var r = h(a.getObservers(s)), o = r.next(); !o.done; o = r.next()) {
                            (0, o.value)(t, i)
                        }
                    } catch (t) {
                        e = {
                ...
                return a.installedProperties.add(s), Object.defineProperty(t, s, i), a
            }(t, e).getObservers(e);
            return i.push(n),
                function() {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.setObserversEnabled = e.getDescriptor = e.observeProperty = e.mdcObserver = void 0, e.mdcObserver = function(t) {
            void 0 === t && (t = function() {});
            var e, p = new WeakMap;
            return r(n, e = t), n.prototype.observe = function(t, e) {
                var n, i, s = this,
                    a = [];
                try {
                    for (var r = h(Object.keys(e)), o = r.next(); !o.done; o = r.next()) {
                        var c = o.value,
                            u = e[c].bind(this);
                        a.push(f(t, c, u))
                    }
                ...
                function l() {
                    var e, t;
                    try {
                        for (var n = h(a), i = n.next(); !i.done; i = n.next())(0, i.value)()
                    } catch (t) {
                        e = {
                            error: t
                        }
                    ...
                    var r = p.get(s) || [],
                        o = r.indexOf(l); - 1 < o && r.splice(o, 1)
                }
                var d = p.get(this);
                ...
                var e, t, n = p.get(this) || [];
                try {
                    for (var i = h(a([], s(n))), r = i.next(); !r.done; r = i.next())(0, r.value)()
                } catch (t) {
                    e = {
                        error: t
                    }
        ...
        function d(t, e) {
            for (var n, i = t; i && !(n = Object.getOwnPropertyDescriptor(i, e));) i = Object.getPrototypeOf(i);
            return n
        }
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(219), e), r(n(220), e), r(n(108), e), r(n(107), e), r(n(224), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var s, a = n(1),
            ...
            h = 0,
            f = (s = a.MDCComponent, r(y, s), y.attachTo = function(t) {
                return new y(t)
            }, Object.defineProperty(y.prototype, "focusOnActivate", {
                set: function(t) {
                    var e, n;
                    try {
                        for (var i = o(this.tabList), r = i.next(); !r.done; r = i.next()) r.value.focusOnActivate = t
                    } catch (t) {
                        e = {
                            error: t
                        }
                ...
                }), this.tabList = this.instantiateTabs(t), this.tabScroller = this.instantiatetabScroller(e)
            }, y.prototype.initialSyncWithDOM = function() {
                var e = this;
                ...
                try {
                    for (var n = o(this.tabList), i = n.next(); !i.done; i = n.next()) i.value.destroy()
                } catch (t) {
                    e = {
                        error: t
                    }
                ...
                var n = this,
                    t = {
                        ...
                        notifyTabActivated: function(t) {
                            return n.emit(p.TAB_ACTIVATED_EVENT, {
                                index: t
                            }, !0)
                        }
                    };
                ...
                return [].slice.call(this.root.querySelectorAll(p.TAB_SELECTOR))
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(226), e), r(n(102), e), r(n(104), e), r(n(17), e), r(n(103), e), r(n(105), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var a = o(n(100));
        e.util = a, s(n(228), e), s(n(98), e), s(n(36), e), s(n(99), e), s(n(229), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(231), e), r(n(101), e), r(n(106), e), r(n(38), e), r(n(232), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(234), e), r(n(235), e), r(n(40), e), r(n(111), e), r(n(236), e), r(n(237), e), r(n(239), e), r(n(241), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var u, l = n(1),
            ...
            I = n(41),
            S = n(114),
            y = (u = l.MDCComponent, r(C, u), C.attachTo = function(t) {
                return new C(t)
                ...
                !y && p && d && (y = d.querySelector(f.ROOT_SELECTOR)), this.characterCounter = y ? i(y) : null;
                var C = this.root.querySelector(A.strings.LEADING_ICON_SELECTOR);
                this.leadingIcon = C ? r(C) : null;
                var E = this.root.querySelector(A.strings.TRAILING_ICON_SELECTOR);
                this.trailingIcon = E ? r(E) : null, this.prefix = this.root.querySelector(A.strings.PREFIX_SELECTOR), this.suffix = this.root.querySelector(A.strings.SUFFIX_SELECTOR), this.ripple = this.createRipple(t)
            }, C.prototype.destroy = function() {
                ...
                var t = o(o(o(o(o({}, this.getRootAdapterMethods()), this.getInputAdapterMethods()), this.getLabelAdapterMethods()), this.getLineRippleAdapterMethods()), this.getOutlineAdapterMethods());
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.characterCountStrings = e.characterCountCssClasses = void 0, r(n(238), e), r(n(109), e), r(n(39), e);
        var o = n(110);
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.helperTextStrings = e.helperTextCssClasses = void 0, r(n(240), e), r(n(112), e), r(n(41), e);
        var o = n(113);
        Object.defineProperty(e, "helperTextCssClasses", {
            enumerable: !0,
            get: function() {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.iconStrings = e.iconCssClasses = void 0, r(n(242), e), r(n(114), e), r(n(115), e);
        var o = n(116);
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(244), e), r(n(245), e), r(n(117), e), r(n(42), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
                ...
                var r = this,
                    t = {
                        ...
                        setSurfaceAnimationStyleProperty: function(t, e) {
                            var n = r.root.querySelector("." + a.CssClasses.SURFACE_ANIMATION);
                        ...
                        deregisterAnchorEventHandler: function(t, e) {
                            var n;
                            null === (n = r.anchorElem) || void 0 === n || n.removeEventListener(t, e)
                        },
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), r(n(247), e), r(n(248), e), r(n(9), e), r(n(44), e), r(n(118), e), r(n(119), e), r(n(43), e)
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var s, a = n(1),
            ...
            h = (s = a.MDCComponent, r(f, s), f.attachTo = function(t) {
                ...
                var t = [].slice.call(this.root.querySelectorAll(u.strings.ACTION_ITEM_SELECTOR));
                this.navIcon && t.push(this.navIcon), this.iconRipples = t.map(function(t) {
                    var e = n(t);
                ...
                this.root.classList.contains(u.cssClasses.SHORT_CLASS) || t || window.addEventListener("resize", this.handleWindowResize)
            }, f.prototype.destroy = function() {
                var e, t;
                try {
                    for (var n = o(this.iconRipples), i = n.next(); !i.done; i = n.next()) i.value.destroy()
                } catch (t) {
                    e = {
                        error: t
                    }
                ...
                this.root.classList.contains(u.cssClasses.SHORT_CLASS) || r || window.removeEventListener("resize", this.handleWindowResize), s.prototype.destroy.call(this)
            }, f.prototype.setScrollTarget = function(t) {
                this.scrollTarget.removeEventListener("scroll", this.handleTargetScroll), this.scrollTarget = t, this.handleTargetScroll = this.foundation.handleTargetScroll.bind(this.foundation), this.scrollTarget.addEventListener("scroll", this.handleTargetScroll)
            }, f.prototype.getDefaultFoundation = function() {
                var n = this,
                    t = {
                        hasClass: function(t) {
                        ...
                        getTotalActionItems: function() {
                            return n.root.querySelectorAll(u.strings.ACTION_ITEM_SELECTOR).length
                        }
                    };
                return this.root.classList.contains(u.cssClasses.SHORT_CLASS) ? new d.MDCShortTopAppBarFoundation(t) : this.root.classList.contains(u.cssClasses.FIXED_CLASS) ? new l.MDCFixedTopAppBarFoundation(t) : new p.MDCTopAppBarFoundation(t)
            }, f);
